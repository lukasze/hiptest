...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './glasses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GLASSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_GLASSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GLASSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GLASSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GLASSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GLASSES actions', async () => {
      const expectedActions = [
        {
