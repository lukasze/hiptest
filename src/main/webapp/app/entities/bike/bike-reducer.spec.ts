...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bike.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIKE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BIKE actions', async () => {
      const expectedActions = [
        {
