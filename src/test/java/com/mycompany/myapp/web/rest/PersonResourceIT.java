...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
        return person;
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
