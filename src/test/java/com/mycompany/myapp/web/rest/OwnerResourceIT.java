...
class OwnerResourceIT {
    ...
    public static Owner createEntity(EntityManager em) {
        Owner owner = new Owner().name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME).mileage(DEFAULT_MILEAGE);
        return owner;
    }
    ...
    public static Owner createUpdatedEntity(EntityManager em) {
        Owner owner = new Owner().name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).mileage(UPDATED_MILEAGE);
        return owner;
    }
    ...
    void createOwner() throws Exception {
        ...
        assertThat(testOwner.getMileage()).isEqualTo(DEFAULT_MILEAGE);
    }
    ...
    void putNewOwner() throws Exception {
        ...
        updatedOwner.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).mileage(UPDATED_MILEAGE);
        ...
        assertThat(testOwner.getMileage()).isEqualTo(UPDATED_MILEAGE);
    }
    ...
    void partialUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.lastName(UPDATED_LAST_NAME).mileage(UPDATED_MILEAGE);
    ...
    void fullUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).mileage(UPDATED_MILEAGE);
